    ...
    render() {
        ...
        return (
            <th>
                {this.props.column}
                <button
                    onClick={this.handleSort} className={currentSort === 'asc' ? 'SortableColumnHeader-current' : ''}
                    name="asc">&#x25B2;</button>
                <button
                    onClick={this.handleSort} className={currentSort === 'desc' ? 'SortableColumnHeader-current' : ''}
                    name="desc">&#x25BC;</button>
            </th>
        );
    }
